...
| Path | Role |
|------|------|
| `SPEC.md` | Normative RaC v0.5.4 protocol |
...
`SPEC.md` is the normative source for RaC v0.5.4. When any other artifact conflicts with it, `SPEC.md` wins. Examples, the skill, and the schemas are derived and must stay consistent.
